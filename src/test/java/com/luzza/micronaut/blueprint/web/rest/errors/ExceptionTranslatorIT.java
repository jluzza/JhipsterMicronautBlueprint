package com.luzza.micronaut.blueprint.web.rest.errors;

import com.luzza.micronaut.blueprint.RedisTestContainerExtension;
import com.luzza.micronaut.blueprint.BlueprintApp;
import com.luzza.micronaut.blueprint.web.rest.errors.handlers.ProblemHandler;
...
@MicronautTest(application = BlueprintApp.class)
